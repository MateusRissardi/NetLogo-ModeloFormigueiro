patches-own [comida é-ninho?]

turtles-own [energia carregando-comida?]

globals [energia-ninho]
...
to movimentar-formiga
  ifelse energia < 1 [die]
  [ ifelse carregando-comida?[ face patch 0 0 forward velocidade-formigas set energia energia - 0.75] [ right random 360 forward velocidade-formigas + 0.2 set energia energia - 0.25] ]
end
